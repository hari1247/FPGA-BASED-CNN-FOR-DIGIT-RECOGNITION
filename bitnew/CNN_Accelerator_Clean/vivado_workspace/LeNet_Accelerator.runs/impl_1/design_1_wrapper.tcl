namespace eval ::optrace {
  variable script "D:/ash/bitnew/CNN_Accelerator_Clean/vivado_workspace/LeNet_Accelerator.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "create in-memory project" START { }
  ...
  set_property board_part_repo_paths {C:/Users/hp/AppData/Roaming/Xilinx/Vivado/2025.2/xhub/board_store/xilinx_board_store} [current_project]
  set_property board_part digilentinc.com:zedboard:part0:1.1 [current_project]
  set_property design_mode GateLvl [current_fileset]
  set_param project.singleFileAddWarning.threshold 0
OPTRACE "create in-memory project" END { }
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir D:/ash/bitnew/CNN_Accelerator_Clean/vivado_workspace/LeNet_Accelerator.cache/wt [current_project]
  set_property parent.project_path D:/ash/bitnew/CNN_Accelerator_Clean/vivado_workspace/LeNet_Accelerator.xpr [current_project]
  set_property ip_output_repo D:/ash/bitnew/CNN_Accelerator_Clean/vivado_workspace/LeNet_Accelerator.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet D:/ash/bitnew/CNN_Accelerator_Clean/vivado_workspace/LeNet_Accelerator.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files D:/ash/bitnew/CNN_Accelerator_Clean/vivado_workspace/LeNet_Accelerator.srcs/sources_1/bd/design_1/design_1.bd
